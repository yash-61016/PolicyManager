...
public class Option1 {
    ...
    public static void newPolicy() throws IOException {
        ...
        calculations.policyToFile(final_name, final_ref_num, final_numOfGad, final_mostExpGad, final_excess, final_premium, final_term, getDate());//apending policy to file
        
        calculations.printPolicy(final_name, final_ref_num, final_numOfGad, final_mostExpGad, final_excess, final_premium, final_term, getDate());//printing policy
    }
